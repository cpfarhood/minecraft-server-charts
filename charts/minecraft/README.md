...
When [persistence.dataDir.enabled in values.yaml](https://github.com/cpfarhood/minecraft-server-charts/blob/master/charts/minecraft/values.yaml#L171) is set to true PersistentVolumeClaim is created and mounted for saves but not mods. In order to enable this functionality
