...
When [persistence.dataDir.enabled in values.yaml](https://git.farh.net/farhoodliquor/minecraft-server-charts/src/branch/master/charts/minecraft/values.yaml#L171) is set to true PersistentVolumeClaim is created and mounted for saves but not mods. In order to enable this functionality
